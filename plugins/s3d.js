...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 's3d ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/text3dbox?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sanony?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://lolhuman.herokuapp.com/api/ephoto1/anonymhacker?apikey=f600e65bf9acbee2b548bf6b&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'saveng ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/logoaveng?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text1=MARVEL&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sbneon ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/bneon?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sbook ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/nulis?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sbp ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/logobp?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sbrand ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/brand-logo?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&type=1&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sbreakwall ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/breakwall?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'scl ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/crosslogo?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'scrismes ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/crismes?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sdropwater ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/dropwater?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sepep ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/epep?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sfire ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/tfire?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sglow ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/glowtext?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sgplay ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/gplaybutton?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sgtext ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/gtext?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text1=${encodeURIComponent(match[1])}&text2=GANG`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sht ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/hartatahta?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sleave ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/leavest?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'sphlogo ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/phlogo?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text1=${encodeURIComponent(match[1])}&text2=HUB`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'spubg ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/pubglogo?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text1=AKINA%20SL&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'ssandw ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/sandw?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'ssilk ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/silktext?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'ssky ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/skytext?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'ssmoke ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/smoketext?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'ssn ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/snowwrite?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text1=AKINA%20SL&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'ssplay ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/splaybutton?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'swatercolour ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/watercolour?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text1=AKINA%20SL&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'scoding ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/matrix?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'swolf ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/wolflogo?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text1=AKINA&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
