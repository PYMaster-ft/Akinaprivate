...
Asena.addCommand({pattern: 'break ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.zeks.xyz/api/breakwall?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${match[1]}`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/ph?text=${topText}&text2=${bottomText}&APIKEY=d83b8bd7dca9ff28`, { responseType: 'arraybuffer' })
   ...
   Asena.addCommand({pattern: 'blood ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/bloodontheroastedglass?text=${match[1]}&APIKEY=d83b8bd7dca9ff28`, { responseType: 'arraybuffer' })
  ...
  Asena.addCommand({pattern: '1917 ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/1917?text=${match[1]}&APIKEY=d83b8bd7dca9ff28`, { responseType: 'arraybuffer' })

    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: Config.AFN})

    }));
  
   Asena.addCommand({ pattern: 'hack?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.zeks.xyz/api/text3dbox?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${match[1]}`, { responseType: 'arraybuffer' })
  ...
  Asena.addCommand({pattern: 'ffire ?(.*)', fromMe: true, dontAddCommandList: false, desc: 'add your text to random freefire logo'}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.zeks.xyz/api/epep?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${match[1]}`, { responseType: 'arraybuffer' })
  ...
  Asena.addCommand({pattern: 'window ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`http://lolhuman.herokuapp.com/api/ephoto1/wetglass?apikey=f600e65bf9acbee2b548bf6b&text=${match[1]}`, { responseType: 'arraybuffer' })
   ...
   Asena.addCommand({pattern: 'holo ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.xteam.xyz/textpro/holographic3d?text=${match[1]}&APIKEY=d83b8bd7dca9ff28`, { responseType: 'arraybuffer' })
   ...
   Asena.addCommand({pattern: 'drop ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    var webimage = await axios.get(`https://api.zeks.xyz/api/dropwater?apikey=0NBxfeRdBGjAkLUn20ecJ0GEicw&text=${match[1]}`, { responseType: 'arraybuffer' })
